<%-- 
    Document   : update_spot
    Created on : Jan 29, 2023, 3:33:53 PM
    Author     : Yash
--%>
...
<head>
    ...
    <title>Admin | Update Crime Spots</title>
    ...
    <%
            ...
            PreparedStatement stmt1=con.prepareStatement("select * from CRIMESPOTS where id=?;");  
            stmt1.setInt(1,n);
            ...
            while (rs.next()) {
                ...
                ar=rs.getString("AREA");
                cs=rs.getString("STATUS");
                pd=rs.getString("PUNISH");
                cfn=rs.getString("CNAME");
                cln=rs.getString("LNAME");
                cd=rs.getString("DATE");  
    ...
    <main class="main">
        ...
        <div class="container form">
            <div class="row">
                ...
                <div class="col-8">
                    <form class="row g-3 needs-validation" action="process_updated_spot" method="post">
                        <div align="center" class="red form-in-title">
                            <h2>Crime Spot Details</h2>
                        </div>
                        <div class="col-md-4">
                          <label for="validationCustom01" class="form-label">State</label>
                          <input type="text" value="<%=st%>" name="state" class="form-control" id="validationCustom01" required>
                        ...
                        <div class="col-md-4">
                          ...
                          <input type="text" value="<%=ci%>" name="city" class="form-control" id="validationCustom02" required>
                          <div class="invalid-feedback field">
                            Please fill this field!
                          </div>
                        </div>
                        <div class="col-md-4">
                          <label for="validationCustom02" class="form-label">Local Area Name</label>
                          <input type="text" name="area" value="<%=ar%>" class="form-control" id="validationCustom02" required>
                          <div class="invalid-feedback field">
                            Please fill this field!
                          </div>
                        </div>
                        <div class="col-md-12">
                          <label for="validationCustomUsername" class="form-label">Proper Address</label>
...
<!--                        <div class="col-md-4">
                        ...
                        <div align="center" class="red form-in-title">
                            <h2>Crimimal Related with this Spot</h2>
                        </div>
                        ...
                        <div class="col-md-4">
                            <label for="validationCustom05"  class="form-label">Criminal First Name</label>
                            <input type="text" name="c_first_name" value="<%=cfn%>" class="form-control" id="validationCustom05" required>
                            <div class="invalid-feedback field">
                              Please fill this field!
                            </div>
                          </div>
                        <div class="col-md-4">
                            <label for="validationCustom05" class="form-label">Criminal Last Name</label>
                            <input type="text" name="c_last_name" value="<%=cln%>" class="form-control" id="validationCustom05" required>
                            <div class="invalid-feedback field">
                              Please fill this field!
                            </div>
                          </div>
                        <div class="col-md-4">
                            ...
                            <input type="date" name="crimedate" value="value="<%=cd%>"" class="form-control" id="validationCustom05" required>
                            <div class="invalid-feedback field">
                              Please fill this field!
                            </div>
                          </div>
                ...
                <div class="col-4">
                    <h1 align="center" class=" main-title red">Update Selected <br>  Crime Spot</h1>
                    <img src="" alt="">
                </div>
