<%-- 
    Document   : add_spots
    Created on : Jan 24, 2023, 3:18:06 PM
    Author     : Yash
--%>
...
<head>
    ...
    <title>Admin | Add Crime Spots</title>
    ...
    <main class="main">
        ...
        <div class="container form">
            <div class="row">
                ...
                <div class="col-8">
                    <form class="row g-3 needs-validation" action="process_added_spot" method="post">
                        ...
                        <div class="col-md-4">
                          ...
                          <input type="text" name="state" class="form-control" id="validationCustom01" required>
                        ...
                        <div class="col-md-4">
                          ...
                          <input type="text" name="area" class="form-control" id="validationCustom02" required>
                          <div class="invalid-feedback field">
                            Please fill this field!
                          </div>
                        </div>
                        <div class="col-md-12">
                          ...
                          <textarea rows="3" name="address"  class="form-control" id="validationCustom02" required></textarea>
                          <div class="invalid-feedback field">
                            Please fill this field!
                          </div>
                        </div>
<!--                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="c_first_name" class="form-control" id="validationCustom05" required>
                            <div class="invalid-feedback field">
                              Please fill this field!
                            </div>
                          </div>
                        <div class="col-md-4">
                            ...
                            <input type="text" name="c_last_name" class="form-control" id="validationCustom05" required>
                            <div class="invalid-feedback field">
                              Please fill this field!
                            </div>
                          </div>
                        <div class="col-md-4">
                            ...
                            <input type="date" name="crimedate" class="form-control" id="validationCustom05" required>
                            <div class="invalid-feedback field">
                              Please fill this field!
                            </div>
                          </div>
                          <div class="col-md-4">
                            ...
                            <select class="form-select" name="criminal_Status" id="validationCustom042" required>
                            <option selected disabled value="NULL">Choose</option>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="punishment_duration" class="form-control" id="validationCustom05" required>
                                <div class="invalid-feedback field">
                                    Please fill this field!
                                  </div>
                                </div>
                ...
                <div class="col-4">
                    <h1 align="center" class=" main-title red">Add  New <br>  Crime Spots</h1>
                    <img src="" alt="">
                </div>
