...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    ...
    <title>Admin | Edit Criminals</title>
...
<%
            ...
            PreparedStatement stmt1=con.prepareStatement("select * from CRIMINALSDATA;");  
                    ...
                    <div class="card-body bgcolor row">
                        <div class="col-6">
                            <ul class="list-group bgcolor emp">
                                <li class="list-group-item list-group-item-light bgcolor">Crime Type : </li>
                                <li class="list-group-item list-group-item-dark bgcolor">Criminal Status : </li>
                                <li class="list-group-item list-group-item-dark bgcolor">Punishment Duration : li>
                            </ul>

                        </div>
                        <div class="col-6">
                            <ul class="list-group bgcolor emp">
                                <li class="list-group-item list-group-item-light bgcolor">Victim name : </li>
                                <li class="list-group-item list-group-item-dark bgcolor">Crime Date :</li>
                                <li class="list-group-item list-group-item-dark bgcolor">Address : </li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-2"><br><br><br>
                                <form action="criminal_update" method="POST">
                                    <button type="submit" name="id" value="" class="btn udb col-6 btn-light"> Update</button>  </form>
                                    <form action="criminal_update" method="POST">
                            <button type="submit" name="id" value=" class="btn udb col-6 btn-light"> Delete</button></form>
                </div>-->
                     <!--end-->       
                <br>
            </div>
