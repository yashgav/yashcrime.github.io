...
<%
            ...
            PreparedStatement stmt1=con.prepareStatement("select * from CRIMINALSREQUEST ;");  
...
<body>
    <main class="main">
        ...
        <div class=" container">
            <h1 align="center">Criminal Requests by Users</h1>
...
<script>
    $(function(){
        $('.db').on('click',function(){
            return confirm("Are you sure you want to Deny this Criminal Request?");
        });
        $('.ub').on('click',function(){
            return confirm("Are you sure you want to Accept this Criminal Request?");
