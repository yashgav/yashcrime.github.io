    ...
    <main class="main">
        ...
        <div class="container form">
            <div class="row">
                ...
                <div class="col-8">
                    <form class="row g-3 needs-validation" action="process_added_criminal" method="post">
...
<!--                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="victim_first_name" class="form-control" id="validationCustom05" required>
                            <div class="invalid-feedback field">
                              Please fill this field!
                            </div>
                          </div>
                        <div class="col-md-4">
                            ...
                            <input type="text" name="victim_last_name" class="form-control" id="validationCustom05" required>
                            <div class="invalid-feedback field">
                              Please fill this field!
                            </div>
                          </div>
                ...
                <div class="col-4">
                    <h1 align="center" class=" main-title red">Add  New  Criminal's <br> Details</h1>
                    <img src="" alt="">
                </div>
